...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <!-- --- 3. Filter Navigasi --- -->
            <div class="kartu" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; flex-wrap: wrap; gap: 15px;">
            ...
            <?php if ($count_months == 0): ?>
                ...
                <div class="empty-chart-state">
                    <div style="background: #ebf8ff; width: 100px; height: 100px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 25px; border: 2px solid #bee3f8;">
                    ...
                    <p style="color: #718096; max-width: 500px; margin: 0 auto;">
                        Grafik tren performa tahun <strong><?php echo $tahun_aktif; ?></strong> belum tersedia. Silakan tunggu hingga proses penilaian bulanan diselesaikan oleh Divisi terkait.
                    </p>
                </div>
            <?php else: ?>
                <!-- --- 5. Grafik Tren --- -->
                <div class="chart-container">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        <h3 style="color: #1e293b; margin: 0; font-size: 1.1em; font-weight: 700;">
                            <i class="fas fa-chart-line" style="color: #0245a3; margin-right: 8px;"></i> Tren Performa Bulanan
                        </h3>
                        <span style="font-size: 0.85em; background: #e2f1ff; color: #0056b3; font-weight: bold; padding: 4px 10px; border-radius: 6px;">
